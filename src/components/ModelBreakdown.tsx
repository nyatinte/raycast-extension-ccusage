  ...
  const getDetailMetadata = () => {
    ...
    return (
      <List.Item.Detail.Metadata>
        ...
        <List.Item.Detail.Metadata.Label 
          title="Total Cost" 
          text={DataFormatter.formatCost(costBreakdown.totalCost)} 
        />
        <List.Item.Detail.Metadata.Label 
        ...
        {efficiency.mostEfficientModel && (
          <>
            ...
            <List.Item.Detail.Metadata.Label 
              ...
              icon={{ source: getModelIcon(efficiency.mostEfficientModel), tintColor: getModelIconColor(efficiency.mostEfficientModel) }}
            />
            <List.Item.Detail.Metadata.Label 
          ...
          tierModels.length > 0 && (
            <div key={tier}>
              ...
              {tierModels.slice(0, 3).map((model) => {
                const percentage = tokenBreakdown.totalTokens > 0 
